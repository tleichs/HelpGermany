 ...
 */
public class SitesI extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater,ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_sites_i,container,false);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        btn5 = (Button) getActivity().findViewById(R.id.btnambasciata);
        btn5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Intent.ACTION_VIEW);
                i.setData(Uri.parse("http://www.ambberlino.esteri.it/ambasciata_berlino/it/"));
                getActivity().startActivity(i);
